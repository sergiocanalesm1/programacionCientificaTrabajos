...
def punto4():
    ...
    '''
    if intersectionX % 4 != 0:#esto hace que diga el año en el que los olímpicos se llevan a cabo (cada 4 años) y que las mujeres igualan of superan a los hombres
        c = int(intersectionX/4)
        Xolimpico = (c+1)*4
        Yolimpico = m2*intersectionX+b2
        plt.text(Xolimpico + 20, Yolimpico + 1,"({} , {})".format(round(Xolimpico, 2), round(Yolimpico, 2)))
    '''
